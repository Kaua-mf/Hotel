...
public class TelaBuscaServico extends javax.swing.JDialog {
  ...
  // DENTRO DA CLASSE TelaBuscaServico.java

public void preencheTabela(java.util.List<model.Servico> listaServicos) {
    // 1. Obtém o modelo da tabela a partir do componente JTable
    javax.swing.table.DefaultTableModel modelo = (javax.swing.table.DefaultTableModel) jTableDados.getModel();
    
    // 2. Limpa a tabela, removendo todas as linhas existentes para exibir os novos dados
    modelo.setRowCount(0);

    // 3. Itera sobre a lista de serviços recebida
    for (model.Servico servico : listaServicos) {
        // 4. Adiciona uma nova linha na tabela para cada serviço da lista
