...
import model.TipoQuarto; // Importe o modelo TipoQuarto
/**
 *
 * @author house
 */
public class TelaCadastroQuarto extends javax.swing.JDialog {
  ...
  // O campo de "Descrição" do quarto usa o componente jTextFieldObs
    public JTextField getjTextFieldDescricao() {
        return jTextFieldObs; 
    }

    // O campo de "Valor da Diária" do quarto usa o componente jFormattedTextField5
    public JFormattedTextField getjFormattedTextFieldValor() {
        return jFormattedTextField5;
    }

    // O campo de "Observação" do quarto usa o componente jTextFieldComplemento
    ...
    private void initComponents() {
        ...
        jLabelNomeFantasia.setText("Tipo de Quarto");
   ...
   public javax.swing.JComboBox<model.TipoQuarto> getjComboBoxTipoQuarto() {
    // Se você reutilizou o jComboBoxSexo, o nome da variável aqui pode ser esse.
    // O importante é que o tipo de retorno do método esteja correto.
