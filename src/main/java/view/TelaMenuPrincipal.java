...
public class TelaMenuPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuItem3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Hourglass.png"))); // NOI18N
        jMenuItem3.setText("Check-In / Check-Out");
...
TelaCadastroModelo telaModelo = new TelaCadastroModelo(null, true);
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
         TelaCheckInOut tela = new TelaCheckInOut();
        tela.setVisible(true);
