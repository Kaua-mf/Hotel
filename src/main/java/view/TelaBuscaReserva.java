...
public class TelaBuscaReserva extends javax.swing.JDialog {
    ...
    private java.util.List<model.Reserva> listaReservas;
    private model.Reserva reservaSelecionada;      
...
public void carregarDados() {
        try {
            ...
            this.listaReservas = dao.Retrieve();
            preencheTabela();
        } catch (Exception e) {
            System.err.println("Erro ao carregar busca: " + e.getMessage());
        }
    }
   ...
   public void preencheTabela() {
        ...
        if (listaReservas != null) {
            for (Reserva r : listaReservas) {
                modelo.addRow(new Object[]{
                    r.getId(),
                    r.getStatus(),
                    (r.getHospede() != null ? r.getHospede().getNome() : "N/I"),
                    r.getDataPrevistaEntrada()
                });
            }
        }
    }

    public model.Reserva getReservaSelecionada() {
    ...
    public JComboBox<String> getjCBFiltro() {
     ...
     public void preencheTabela(java.util.List<model.Reserva> listaReservas) {
    javax.swing.table.DefaultTableModel modelo = (javax.swing.table.DefaultTableModel) jTableDados.getModel();
    modelo.setRowCount(0);

    for (model.Reserva reserva : listaReservas) {
        modelo.addRow(new Object[]{
            reserva.getId(),
            reserva.getHospede().getNome(),
            reserva.getDataPrevistaEntrada(),
            reserva.getDataPrevistaSaida(),
    ...
    private void initComponents() {
        ...
        jButtonCarregar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Load.png"))); // NOI18N
        ...
        jButtonFiltar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Find.png"))); // NOI18N
    ...
    if (linha != -1) {
    reservaSelecionada = listaReservas.get(linha);
    dispose();
}
