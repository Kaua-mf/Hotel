...
public class TelaBuscaFuncionario extends javax.swing.JDialog {
    ...
    this.listaFuncionarios = dao.Retrieve();
    preencheTabela(this.listaFuncionarios);
}
private model.Funcionario funcionarioSelecionado;
private java.util.List<model.Funcionario> listaFuncionarios;
public model.Funcionario getFuncionarioSelecionado() {
    ...
    public void preencheTabela(java.util.List<model.Funcionario> listaFuncionarios) {
        javax.swing.table.DefaultTableModel modelo = (javax.swing.table.DefaultTableModel) jTableDados.getModel();
        modelo.setRowCount(0);

        for (model.Funcionario funcionario : listaFuncionarios) {
    ...
    private void initComponents() {
        ...
        jCBFiltro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nome", "CPF", "Usuario" }));
...
if (linha != -1) {
    funcionarioSelecionado = listaFuncionarios.get(linha);
    dispose();
}
