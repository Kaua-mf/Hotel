...
public class TelaCheckInOut extends javax.swing.JDialog {
    ...
    private JPanel buildPanelCheck() {
        ...
        jPanelCheckTitulo = titulo("Check-in / Checkout", new Color(85, 255, 0));
        ...
        y += 35;
        label(jPanelCheckDados, "Dt/Hr Cadastro:", 20, y);
        jTextFieldCheckDataHoraCadastro = ftf(jPanelCheckDados, 160, y, 180);

        y += 35;
        label(jPanelCheckDados, "Dt/Hr Entrada:", 20, y);
        jTextFieldCheckDataHoraEntrada = ftf(jPanelCheckDados, 160, y, 180);

        y += 35;
        label(jPanelCheckDados, "Dt/Hr Saida:", 20, y);
        jTextFieldCheckDataHoraSaida = ftf(jPanelCheckDados, 160, y, 180);

        y += 35;
        label(jPanelCheckDados, "Reserva:", 20, y);
        ...
        y += 35;
        label(jPanelCheckDados, "Obs:", 20, y);
    ...
    private JPanel buildPanelCheckHospede() {
        ...
        jPanelCheckHospedeTitulo = titulo("Pessoas do Check", new Color(0, 125, 255));
    ...
    private JPanel buildPanelCheckQuarto() {
        ...
        jPanelCheckQuartoTitulo = titulo("Quartos do Check", new Color(143, 0, 255));
...
//  Botão Adicionar (Aba 3)
    ...
    private JPanel buildPanelAlocacaoVaga() {
        ...
        jPanelAlocacaoVagaTitulo = titulo("Alocacao de Vagas", new Color(255, 0, 230));
    ...
    private JPanel buildPanelReceber() {
        ...
        jPanelReceberTitulo = titulo("Recebimento do Check", new Color(156, 18, 74));
    ...
    private JButton btn(String texto, String icone, String cmd) {
        ...
        try {
            b.setIcon(new ImageIcon(getClass().getResource(icone)));
    ...
    public JButton getjButtonCheckSair() {
        return jButtonCheckSair;
    }

    public JTextField getjTextFieldCheckId() {
        return jTextFieldCheckId;
    }

    public JFormattedTextField getjTextFieldCheckDataHoraCadastro() {
        return jTextFieldCheckDataHoraCadastro;
    }

    public JFormattedTextField getjTextFieldCheckDataHoraEntrada() {
        return jTextFieldCheckDataHoraEntrada;
    }

    public JFormattedTextField getjTextFieldCheckDataHoraSaida() {
        return jTextFieldCheckDataHoraSaida;
    }

    public JTextField getjTextFieldCheckObs() {
        return jTextFieldCheckObs;
    }

    public JComboBox<Reserva> getjComboBoxCheckReserva() {
        return jComboBoxCheckReserva;
    }

    public JButton getjButtonCheckNovo() {
        return jButtonCheckNovo;
    }

    public JButton getjButtonCheckGravar() {
        return jButtonCheckGravar;
    }

    public JButton getjButtonCheckCancelar() {
        return jButtonCheckCancelar;
    }

    public JButton getjButtonCheckBuscar() {
        return jButtonCheckBuscar;
    }

    public JPanel getjPanelCheckDados() {
        return jPanelCheckDados;
    }

    public JPanel getjPanelCheckBotoes() {
        return jPanelCheckBotoes;
    }
    ...
    campo.setInputVerifier(new InputVerifier() {
        ...
        public boolean verify(JComponent input) {
            ...
            String textoLimpo = ftf.getText().replace("-", "").replace(":", "").trim();
            ...
            try {
                ...
                java.time.LocalDateTime dataHora = java.time.LocalDateTime.parse(ftf.getText(), formato);
                
                int ano = dataHora.getYear();
                if (ano < 2000 || ano > 2100) {
                    throw new Exception("Ano fora do limite aceitável (2000-2100)");
                }
