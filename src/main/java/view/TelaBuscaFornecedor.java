...
private model.Fornecedor fornecedorSelecionado;
private java.util.List<model.Fornecedor> listaFornecedores;
public model.Fornecedor getFornecedorSelecionado() {
    return fornecedorSelecionado;
}
public void carregarDados() {
    DAO.FornecedorDAO dao = new DAO.FornecedorDAO();
    this.listaFornecedores = dao.Retrieve();
    preencheTabela(this.listaFornecedores);
}
    ...
    private void initComponents() {
        ...
        jTableDados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Nome", "Razão Social", "CNPJ", "Status"
            }
        ));
        ...
        jCBFiltro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Id", "Nome", "CNPJ" }));
