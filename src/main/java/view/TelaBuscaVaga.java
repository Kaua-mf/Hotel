...
public class TelaBuscaVaga extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        setTitle("Busca de Vaga de Estacionamento");
        setAlwaysOnTop(true);
        setResizable(false);
        ...
        jTableDados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Descrição", "MetragemVaga", "OBS", "Status"
            }
        ));
        ...
        if (jTableDados.getColumnModel().getColumnCount() > 0) {
            ...
            jTableDados.getColumnModel().getColumn(1).setMaxWidth(60);
            jTableDados.getColumnModel().getColumn(2).setMaxWidth(270);
        ...
        jCBFiltro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Descrição", "Metragem Vaga" }));
