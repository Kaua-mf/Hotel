...
private java.util.List<model.Hospede> listaHospedes;
...
public void carregarDados() {
    ...
    preencheTabela(this.listaHospedes);
}
   ...
   public void preencheTabela(java.util.List<model.Hospede> listaHospedes) {
    javax.swing.table.DefaultTableModel modelo = (javax.swing.table.DefaultTableModel) jTableDados.getModel();
    modelo.setRowCount(0);

    for (model.Hospede hospede : listaHospedes) {
        modelo.addRow(new Object[]{
            hospede.getId(),
            hospede.getNome(),
            hospede.getCpf(),
    ...
    private void initComponents() {
        ...
        jCBFiltro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nome", "CPF", "RG" }));
...
if (linha != -1) {
    hospedeSelecionado = listaHospedes.get(linha);
    dispose();
}
